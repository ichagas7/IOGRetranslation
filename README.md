...
1.) [What is This Patch?](#1-what-is-this-patch)  
2.) [Application Instructions](#2-application-instructions)  
3.) [MSU Instructions](#3-msu-instructions)  
...
☄ Added an original sprite for the Sky Deliveryman, designed by _Azure Mage_.  
